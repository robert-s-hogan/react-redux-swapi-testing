const BottomMountain = ({ surfaceColor, styles }) => {
  return (
    <>
      <p className="text-white">
        <span className="bg-black">BottomMountain > {surfaceColor}</span>
      </p>
      <svg
        className={`mountain-bottom fill-mountain-bottom-${surfaceColor} ${styles} -z-4`}
